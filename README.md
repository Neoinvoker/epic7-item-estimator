...
8. 强化的计算过程参考下面这张流程图：
   ...
   **这张截图出处是哪个视频我并不清楚，也特别感谢该视频的作者以及强化思路的创作者，如有知道出处的请告知我，我会随后附上**
   ...
   1. 目前考虑增加一键强化装备的功能，但这个功能具体该如何实现还在思考中（比如是否要强化所有的装备还是限定属性强化？比如强化后不需要的装备是否要出售/萃取？强化最终阶段是否要重铸？）
   2. 新增强化记录功能，保留每次的强化记录
   3. 新增自动识别模式，通过ADB发送点击，尽可能减少人工操作
   4. 新增点位像素检测，用更低的代价和更高的执行效率完成自动化操作
   5. 编写开发文档，提高二次开发效率
   6. 美化UI
   7. 改善安装方式，提供bat脚本一键安装，目前的安装过程比较繁琐，可能劝退了不少人
